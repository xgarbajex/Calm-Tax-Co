    ...
    <section id="how-it-works" className="py-32 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  {!isLast && (
                    <div className="absolute top-[64px] sm:top-[72px] bottom-[-8px] left-[calc(50%-56px)] right-[calc(50%-56px)] sm:left-[calc(50%-68px)] sm:right-[calc(50%-68px)] pointer-events-none md:hidden z-0">
                  ...
                  <div className="md:hidden grid grid-cols-2 gap-6 items-start w-full">
                        ...
                        <div className="text-right py-2 max-w-[200px] sm:max-w-[260px] ml-auto relative z-10 pr-4 sm:pr-6">
                         ...
                         <div className="w-full flex justify-start pl-4 sm:pl-6 relative py-2">
                           ...
                           <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white shadow-sm border border-[#7D8E7E]/15 flex items-center justify-center relative z-20 group hover:border-[#7D8E7E]/40 transition-colors duration-300">
                             <span className="text-xl sm:text-2xl font-medium serif-font text-[#7D8E7E]">{index + 1}</span>
                           </div>
                         </div>
                       </>
                     ) : (
                  ...
                  <div className="hidden md:flex md:flex-col md:items-center w-full">
                    ...
                    <div className="flex-none w-16 h-16 rounded-full bg-white shadow-sm border border-[#7D8E7E]/15 flex items-center justify-center relative z-20 md:mb-6 group hover:border-[#7D8E7E]/40 transition-colors duration-300">
                      <span className="text-2xl font-medium serif-font text-[#7D8E7E]">{index + 1}</span>
                      {/* Glow effect */}
        ...
        <div className="text-center mt-16">
          <a
            href="/intake.html"
            className="inline-block bg-[#3C3633] text-white px-10 py-4 rounded-full text-lg hover:bg-[#4d4642] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#3C3633]/20 active:translate-y-0 transition-all duration-300"
          >
