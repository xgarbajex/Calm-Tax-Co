        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            <div className="max-w-xs">
              ...
              <p className="text-xs text-[#3C3633]/65 leading-relaxed">A small, careful tax practice. Conducted entirely by correspondence. Arizona-based. Serving clients remotely in all 50 states, year-round.</p>
