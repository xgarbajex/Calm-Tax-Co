    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#5D6D7E] leading-relaxed text-lg">
          ...
          <p>
            That's what Calm Tax Co. is here for. We're a remote solo practice based in Arizona, handling tax preparation for independent workers, sole proprietors, and small service businesses across all 50 states.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>We e-file your federal and state returns. Your completed return will also include your estimated payment amounts for each quarter of the coming year.</li>
          </ul>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do I file a Schedule C for a solo business?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do I calculate quarterly estimated tax payments?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do taxes work with irregular self-employment income?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">Do I need to get on a phone call with my tax preparer?</h3>
