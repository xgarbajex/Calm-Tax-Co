      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#5D6D7E] leading-relaxed text-lg">
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>You do a mix of gig work alongside a regular job, and you're not sure how they interact on your return.</li>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do gig workers deduct mileage on taxes?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">Why is the self-employment tax for gig workers so high?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do you file taxes with both W-2 and 1099 gig income?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do I send tax documents securely?</h3>
