      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#5D6D7E] leading-relaxed text-lg">
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>We e-file directly with the IRS and your state. For returns that can't be filed electronically, we handle the mailing process.</li>
          </ul>
          ...
          <h2 className="text-2xl serif-font text-[#3C3633] mt-12 mb-6">On Privacy and Security</h2>
          <p>
          ...
          <p>
            It's especially well-suited for people who've moved between states, work remotely themselves, or simply prefer a low-pressure, private way to handle their taxes. If you're a freelancer, self-employed, a W-2 employee, or some combination, we handle all of it.
          </p>

          <p>
            You don't need to be technically sophisticated. If you can follow a link and upload a file, you can work with us.
          </p>

          <h2 className="text-2xl serif-font text-[#3C3633] mt-12 mb-6">Frequently Asked Questions</h2>
          <div className="space-y-6">
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do I send tax documents to a remote tax preparer?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">Can I take a picture of my tax forms instead of scanning them?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">How do I know if my tax situation is too complicated?</h3>
            ...
            <div>
              <h3 className="text-xl text-[#3C3633] font-bold mb-2">Can an online tax preparer file for any state?</h3>
