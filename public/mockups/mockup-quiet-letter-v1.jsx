...
function QuietLetter() {
  ...
  return (
    <div style={{
      ...
      // Subtle paper grain
      backgroundImage: `
        radial-gradient(circle at 18% 20%, rgba(166,109,94,0.04) 0, transparent 50%),
        radial-gradient(circle at 82% 80%, rgba(125,142,126,0.04) 0, transparent 55%)
      `,
    }}>
      {/* ============= MASTHEAD ============= */}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr 180px', gap: 0, alignItems: 'start' }}>
          ...
          <div style={{ paddingTop: 16 }}>
            ...
            <div style={{ marginTop: 36, fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 13, color: QL.slate, lineHeight: 1.6 }}>
              <span style={{ color: QL.terra }}>fol.</span> i<br />
          ...
          <div style={{ textAlign: 'center', padding: '0 20px' }}>
            <QLDisplay size={104} style={{ marginBottom: 36 }}>
              Tax prep<br /><span style={{ color: QL.terra }}>without</span> the dread.
            </QLDisplay>
          ...
          <div style={{ paddingTop: 16, textAlign: 'right' }}>
            <div style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 13, color: QL.slate, lineHeight: 1.6 }}>
              <span style={{ color: QL.terra }}>est.</span> 2026<br />
              by Jennifer,<br />
              from her desk<br />
              in Florida
            </div>
      ...
      {/* Rule with fleuron between sections */}
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 56px' }}>
        <RuleWithMark color={QL.rule} markColor={QL.terra} />
      </div>
          ...
          {COPY.personas.map((p, i) => (
            <article key={i} style={{
              ...
              <div style={{ flex: '0 0 56px' }}>
                <div style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 44, color: QL.terra, lineHeight: 1 }}>
          ...
          <div style={{ borderTop: `1px solid ${QL.rule}`, marginTop: 32 }}>
            {COPY.steps.map((s, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 36, color: QL.terra, lineHeight: 1 }}>{s.n}</div>
      ...
      <section style={{ padding: '120px 56px', maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <QLDisplay size={80} style={{ marginTop: 28 }}>
            Pricing, <span style={{ color: QL.terra }}>plainly stated.</span>
          </QLDisplay>
        </div>
          ...
          {COPY.pricing.map((p, i) => (
            <div key={i} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
                ...
                <span style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 42, color: QL.terra }}>{p.price}</span>
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: 80 }}>
            <div>
              ...
              <QLDisplay size={56} style={{ marginTop: 28 }}>
                Who we’re <span style={{ fontStyle: 'italic', color: QL.terra }}>not</span> the right fit for —<br />yet.
              </QLDisplay>
      ...
      <section style={{ padding: '120px 56px', maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 56, borderTop: `1px solid ${QL.rule}`, paddingTop: 48 }}>
          {COPY.trust.map((t, i) => (
            <div key={i}>
              <div style={{ fontFamily: '"Instrument Serif", serif', fontStyle: 'italic', fontSize: 22, color: QL.terra, marginBottom: 8 }}>
                {String(i + 1).padStart(2, '0')}.
              </div>
      ...
      <section style={{ padding: '140px 56px', maxWidth: 1280, margin: '0 auto', textAlign: 'center' }}>
        ...
        <QLDisplay size={104} style={{ marginTop: 32 }}>
          Let’s <span style={{ color: QL.terra }}>correspond.</span>
        </QLDisplay>
